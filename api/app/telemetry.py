...
def instrument_app(app) -> None:
    """Traces incoming requests. The distro patches the FastAPI module, which does
    not help here because main.py imports the class directly, so the app object is
    instrumented explicitly instead."""
